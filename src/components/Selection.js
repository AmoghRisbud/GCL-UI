                    ...
                    <div className="row-sm-6 text-center mt-20" align='center'>
                        <div className="card w-50 p-5 h-100 d-inline-block" >
                            <div className="card-body text-center mt-20" align='center'>
                                ...
                                <DropdownButton className="w-50 p-5 h-100" id="dropdown-basic-button" title={monthTitle}>
                                    <Dropdown.Item href="#/action-1" onClick={()=>{setmonthTitle("JAN");}}>January</Dropdown.Item>
                                    <Dropdown.Item href="#/action-2"onClick={()=>{setmonthTitle("FEB");}}>February</Dropdown.Item>
                                    <Dropdown.Item href="#/action-3"onClick={()=>{setmonthTitle("MAR");}}>March</Dropdown.Item>
                                    <Dropdown.Item href="#/action-3"onClick={()=>{setmonthTitle("APR");}}>April</Dropdown.Item>
                                    <Dropdown.Item href="#/action-1" onClick={()=>{setmonthTitle("MAY");}}>May</Dropdown.Item>
                                    <Dropdown.Item href="#/action-2"onClick={()=>{setmonthTitle("JUN");}}>June</Dropdown.Item>
                                    <Dropdown.Item href="#/action-3"onClick={()=>{setmonthTitle("JUL");}}>July</Dropdown.Item>
                                    <Dropdown.Item href="#/action-1" onClick={()=>{setmonthTitle("AUG");}}>August</Dropdown.Item>
                                    <Dropdown.Item href="#/action-2"onClick={()=>{setmonthTitle("SEP");}}>September</Dropdown.Item>
                                    <Dropdown.Item href="#/action-3"onClick={()=>{setmonthTitle("OCT");}}>October</Dropdown.Item>
                                    <Dropdown.Item href="#/action-1" onClick={()=>{setmonthTitle("NOV");}}>November</Dropdown.Item>
                                    <Dropdown.Item href="#/action-2"onClick={()=>{setmonthTitle("DEC");}}>December</Dropdown.Item>
                                </DropdownButton>

                                <DropdownButton className=" p-5 h-100" id="dropdown-basic-button" title={yearTitle}>
                                    {year.map(function(item){
                                        var item1=item.toString();
                                        return (<Dropdown.Item href="#/action-1" onClick={()=>{setyearTitle(item1);}}>{item1}</Dropdown.Item>)
                                })}
                                </DropdownButton>
                            </div>
                        </div>
